//封装cookie的方法
let tokenkey = 'sifulan-token';
let userkey = 'sifulan-user';
let searchTag = 'sifulan-search';
...
//设置搜索记录
export function setSearch(value, days) {
    //value:传入的用户信息;days:保留的天数
    setCookie(searchTag, value, days);
}
